    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="editForm">
                ...
                <input type="time" id="edit_start_time" name="edit_start_time" value="">

                <label for="edit_end_time">End Time: <span class="error-message" id="eend_error"><?= htmlspecialchars($eEndError); ?></span></label>
                <input type="time" id="edit_end_time" name="edit_end_time" value="">

                <label for="edit_adviser_name">Adviser Name:</label>
                <select name="edit_adviser_name" id="edit_adviser_name">
                    <?php foreach ($profs as $prof) : ?>
                        <option value="<?= $prof['prof_id']; ?>"><?= htmlspecialchars($prof['prof_name']); ?></option>
                    <?php endforeach; ?>
                ...
                <input type="text" id="edit_student_name" name="edit_student_name" value="">
                ...
                <input type="text" id="edit_capstone_title" name="edit_capstone_title" value="">
